...
public class ProblemBTest {
    ...
    String directory = "/Users/bryce/projects/github/qboiler/codeJam/src/test/inputs/2009/s/qualifying/problemB/";
    ...
    private void executeTest(String inputFile) throws IOException {
        ...
        qboiler.codejam.y2009.s.qualify.ProblemB instance = new qboiler.codejam.y2009.s.qualify.ProblemB();
